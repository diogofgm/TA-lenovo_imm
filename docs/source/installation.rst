...
Install the Lenovo IMM Add-on for Splunk
==================================
- Get the Lenovo IMM Add-on for Splunk by downloading it from `Splunkbase`_ or browsing to it using the app browser within Splunk Web.
...
.. list-table::
   ...
   * - Indexers
     - Yes
     - Optional
     - Required for the parsing operations (e.g. fixing timestamp) if the data is not coming from a heavy forwarder.
   * - Heavy Forwarders
     - Yes
     - Yes
     - Required for the parsing operations (e.g. fixing timestamp).
   * - Universal Forwarders
     - No
     - No
     - This add-on requires either a heavy forwarder or an indexer for the parsing operations (e.g. fixing timestamp).
...
.. list-table::
   ...
   * - Indexer Clusters
     - Yes
     - You can install this add-on on a indexer cluster for all index-time functionality.
   * - Deployment Server
     - Yes
...
.. _Splunkbase: https://splunkbase.splunk.com/app/4703/
